  ...
  const exportToExcel = () => {
    try {
      ...
      const headerData = [
        ...
        [],
        ['STT', 'Mã DN', 'Tên DN', 'Tổng số TK', 'I-Cmt 20', 'I-Cmt 40', 'I-Hàng rời', 'II-Cmt 20', 'II-Cmt 40', 'II-Hàng rời', 'III-Cmt 20', 'III-Cmt 40', 'Thành tiền']
      ]
      ...
      // Set column widths
      ws['!cols'] = [
        { wch: 5 }, { wch: 12 }, { wch: 50 }, { wch: 12 },
        { wch: 10 }, { wch: 10 }, { wch: 12 }, { wch: 10 },
        { wch: 10 }, { wch: 12 }, { wch: 10 }, { wch: 10 }, { wch: 15 }
      ]

      XLSX.utils.book_append_sheet(wb, ws, 'Tình hình sử dụng BL')
      const filename = `TinhHinh_SuDung_BL_${fromDateFormatted.replace(/\//g, '-')}_${toDateFormatted.replace(/\//g, '-')}.xlsx`
...
export default ReceiptUsageHistoryPage
