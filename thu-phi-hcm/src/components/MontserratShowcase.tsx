...
const ArialShowcase: React.FC = () => {
  return (
    <div className="max-w-6xl mx-auto p-8">
      {/* Header */}
      <div className="text-center mb-12">
        <h1 className="text-5xl font-extrabold text-gray-800 mb-4 bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent">
          📝 Arial Font System  
        </h1>
        <p className="text-xl font-medium text-gray-600 max-w-3xl mx-auto">
          Font Arial đã được áp dụng cho toàn bộ hệ thống thu phí Hải quan TP.HCM - Simple, Reliable, Universal
        </p>
      </div>
      ...
      <div className="text-center bg-gradient-to-r from-blue-500 to-green-500 rounded-2xl p-8 text-white">
        <h2 className="text-3xl font-bold mb-4">📝 Font Arial đã sẵn sàng!</h2>
        <p className="text-xl font-medium mb-6">
          Toàn bộ hệ thống thu phí Hải quan TP.HCM giờ đây sử dụng font Arial 
          - Simple, reliable, và universal compatibility
        </p>
